...
public class DAL
{
    ...
    public string IsoStart = " Alter Database ticketscan Set Allow_SnapShot_isolation on; Set Transaction Isolation level read uncommitted;Set nocount on; Begin Tran  ";
    public string IsoEnd = " Commit Tran ";
    public string DBName = "ticketscan";
    public DAL()
    {
